...
//        videoRepository.save(vide8);
       ...
       //Maldron Ireland
        ...
        //Liverpool
        Comment description70 = new Comment("Short walk from Liver Building and iconic Albert Dock",hotel11);
        commentRepository.save(description70);
        Comment description71 = new Comment("Moorfields Metro Station, Castle Street and Town Hall closeby.",hotel11);
        commentRepository.save(description71);
        Comment description72 = new Comment("Short trip from Liverpool John Lennon Airport or Manchester International Airport",hotel11);
